...
const dev = process.env.OWNER_NUMBER || '254712345678';
...
const botUrl = process.env.BOT_PIC || "https://i.ibb.co/pvTCfNqV/0333084a6a55.jpg";
const botGurl = process.env.BOT_GURL || "https://github.com/roy107roy12-netizen/Charlton-xmd";
